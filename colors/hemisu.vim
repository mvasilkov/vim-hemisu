...
call s:h("StatusLine",   { "fg": s:norm, "bg": s:faint, "cterm": "bold" })
...
call s:h("TabLineSel",   { "cterm": "bold" })
...
call s:h("Keyword",    { "fg": s:accent2, "cterm": "bold" })
call s:h("Todo",       { "fg": s:normRed, "cterm": "bold" })
call s:h("Function",   { "cterm": "bold" })
